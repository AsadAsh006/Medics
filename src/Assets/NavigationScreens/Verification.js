  ...
  return (
    <View style={{flex:1, backgroundColor:'white'}}>
      ...
      <View style={{justifyContent:'center', flex:0.3}}>
        ...
        <TextInput placeholder=' ' style={{backgroundColor:'ghostwhite', width:'15%',borderRadius:10,color:'black', fontSize:22,alignItems:'center' }}  maxLength={1} textAlign='center'/>
        <TextInput placeholder=' ' style={{backgroundColor:'ghostwhite', width:'15%', alignSelf:'center',borderRadius:10,color:'black', fontSize:22,alignItems:'center' }} maxLength={1} textAlign='center'/>
        <TextInput placeholder=' ' style={{backgroundColor:'ghostwhite', width:'15%', alignSelf:'center',borderRadius:10,color:'black', fontSize:22,alignItems:'center' }}  maxLength={1} textAlign='center'/>
        <TextInput placeholder=' ' style={{backgroundColor:'ghostwhite', width:'15%', alignSelf:'center',borderRadius:10,color:'black', fontSize:22,alignItems:'center' }} maxLength={1} textAlign='center'/>
      </View>
      </View>
      <CustomButton title={'Verify'} action={()=>navigation.navigate('Newpassword')}/>
